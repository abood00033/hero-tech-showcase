...
const SebaqHeroSection = () => {
  ...
  const stats = [
    ...
    { number: "1000+", label: "آلة تم توريدها" },
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-6">
              {services.map((service, index) => (
                <div 
                  key={index} 
                  className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-sebaaq-blue/50 transition-all duration-300 group hover:bg-white/10"
                >

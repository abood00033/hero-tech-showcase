...
const ContactSection = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-primary/5 via-background to-secondary/5 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-20 w-48 h-48 bg-secondary/10 rounded-full blur-3xl animate-float" style={{animationDelay: '2s'}}></div>
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {/* WhatsApp */}
            <div className="bg-card/50 backdrop-blur-sm rounded-xl p-6 border border-border/50 hover:border-primary/50 transition-all duration-300 group cursor-pointer hover:shadow-lg"
              ...
              <p className="text-primary font-mono">+966 594 196 930</p>
            </div>
            ...
            <div className="bg-card/50 backdrop-blur-sm rounded-xl p-6 border border-border/50 hover:border-primary/50 transition-all duration-300 group cursor-pointer hover:shadow-lg"
              ...
              <h3 className="text-foreground font-semibold mb-2">بريد إلكتروني</h3>
              <p className="text-primary">info@seapaac.com</p>
            </div>
            ...
            <div className="bg-card/50 backdrop-blur-sm rounded-xl p-6 border border-border/50 hover:border-primary/50 transition-all duration-300 group cursor-pointer hover:shadow-lg"
              ...
              <h3 className="text-foreground font-semibold mb-2">موقع إلكتروني</h3>
              <p className="text-primary">www.seapaac.com</p>
            </div>
          </div>

          {/* Main CTA */}
          <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 shadow-xl">
            ...
            <button 
              className="bg-white text-primary px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              onClick={() => window.open('https://wa.me/+966594196930', '_blank')}
            >
              تواصل معنا الآن
            </button>

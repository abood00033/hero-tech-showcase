...
const SebaqMachine = () => {
  ...
  const stats = [
    { number: "90+", label: "آلة تم تركيبها", icon: Cog },
    { number: "800+", label: "عملية صيانة", icon: Settings },
    { number: "60+", label: "عميل دائم", icon: Users },
    { number: "8+", label: "سنوات خبرة", icon: Clock },
    { number: "490+", label: "قطعة غيار", icon: Package }
  ];

  const whyChooseUs = [
    { title: "جودة مضمونة", description: "معايير عالمية في الجودة", icon: Shield },
    { title: "خدمة متميزة", description: "دعم فني على مدار الساعة", icon: Star },
    { title: "أسعار تنافسية", description: "أفضل الأسعار في السوق", icon: Badge },
    { title: "خبرة واسعة", description: "سنوات من الخبرة المتخصصة", icon: Users }
  ];
        ...
        <div className="relative z-10 container mx-auto px-6">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <h1 className="font-playfair text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-8">
              سـي بـاك ماشـين
              <span className="gradient-text block mt-4 text-3xl md:text-5xl lg:text-6xl">
                استشارة • توريد • تركيب • صيانة
              </span>
            </h1>

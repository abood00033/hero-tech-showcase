  ...
  const mainFeatures = [
    {
      ...
      description: "تقدم شركة SEBAQ أحدث أنظمة الغسيل BT500، مزودة بأحدث التقنيات، لأداء عالي جدا وتوفير إمكانية تحقيق أرباح عالية.",
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8">
            ...
            >
              اكتسبت شركة SEBAQ سمعتها باعتبارها واحدة من أكثر أنظمة الغسيل كفاءة وجودة في السوق المحلي.
            </motion.p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-foreground mb-4">
              تم تصميم أنظمة غسيل SEBAQ لتناسب البيئة القاسية في السعودية، باستخدام أفضل القطع من علامات تجارية عالمية معروفة بالجودة وأحدث التقنيات
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              تلتزم SEBAQ بتوفير قطع الغيار محلياً
            </p>
          </motion.div>
